...
const ForbiddenPage = () => {
  return (
    <div className="min-h-screen my-5 flex flex-col items-center justify-center bg-gray-50 px-4">
      {/* Lottie Animation */}
      ...
      {/* Heading */}
      <h1 className="text-4xl sm:text-5xl font-bold text-[#003F62] mb-4 text-center">
        Access Denied
      </h1>
